...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lbl_CutOffRatio = QtWidgets.QLabel(self.gb_Input)
        self.lbl_CutOffRatio.setObjectName("lbl_CutOffRatio")
        self.lbl_CutOffRatio.setFont(font)
        self.lbl_CutOffRatio.setText("Cut-off Ratio (rc)")
        self.gridLayout.addWidget(self.lbl_CutOffRatio, 5, 0, 1, 1, QtCore.Qt.AlignRight)

        self.le_CutOffRatio = QtWidgets.QLineEdit(self.gb_Input)
        self.le_CutOffRatio.setObjectName("le_CutOffRatio")
        self.le_CutOffRatio.setFont(font)
        self.le_CutOffRatio.setMaximumSize(QtCore.QSize(200, 16777215))
        self.le_CutOffRatio.setClearButtonEnabled(True)
        self.gridLayout.addWidget(self.le_CutOffRatio, 5, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Thermodynamic Cycles Simulation"))
        self.gb_Input.setTitle(_translate("Form", "Input Parameters"))
        self.lbl_CutOffRatio.setText(_translate("Form", "Cut-off Ratio (rc)"))
